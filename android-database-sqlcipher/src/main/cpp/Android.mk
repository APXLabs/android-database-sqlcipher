...
LIB_PATH := $(LOCAL_PATH)/../external/android-libs/$(TARGET_ARCH_ABI)

LOCAL_CFLAGS +=  $(SQLCIPHER_CFLAGS) -DLOG_NDEBUG -g
...
#LOCAL_SHARED_LIBRARIES += libsafezone-sw-fips-1.1
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../external/android-libs/$(TARGET_ARCH_ABI)/libsafezone-sw-fips-1.1.so
